...
public class UartService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        if (TX_CHAR_UUID.equals(characteristic.getUuid())) {
            ...
            // Logging received byte
            String receivedValue = new String(characteristic.getValue());
            Log.d(TAG, String.format("Received TX: %s", receivedValue + "in UartService" ));
    ...
    public void writeRXCharacteristic(byte[] value)
    {
        ...
        String display = new String(value);
        Log.d(TAG, "write TXchar - status=" + status + " and values=" + display);
    }
